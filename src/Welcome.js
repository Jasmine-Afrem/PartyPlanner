...
const Welcome = () => {
  ...
  useEffect(() => {
    ...
    function confettiParticle() {
      this.x = Math.random() * (W - 100); // Adjust x position to start further left
      this.y = Math.random() * H - H; // y
      this.r = randomFromTo(20, 50); // Increased radius range for bigger confetti
